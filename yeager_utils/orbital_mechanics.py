...
def calc_heading_itrf(r_itrf, v_itrf):
    ...
    Parameters:
    r_itrf (numpy.ndarray): The position vectors in the ITRF frame, shaped (n, 3), where n is the number of vectors.
    v_itrf (numpy.ndarray): The velocity vectors in the ITRF frame, shaped (n, 3), where n is the number of vectors.
...
def calc_gamma_and_heading(r, t):
    ...
    Notes:
    - This function transforms position and velocity vectors from the GCRF frame to the ITRF frame.
    - Gamma is the angle between the position and velocity vectors, offset by 90 degrees.
