...
from .int_utils import acceleration_adapter, build_profile
...
def leapfrog(
    ...
    *,
    ...
    accels : callable or list[callable] or None
        ...
        Canonical r/v/t (or time/epoch) parameter names declare argument roles;
        other names require ``acceleration_adapter`` or ``acceleration_signature``.
