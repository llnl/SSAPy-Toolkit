...
def main(make_artifacts=None, fast=None):
    ...
    n = 4 if fast else 16
    paths_a = create_varying_frames(n=n, base_size=(320, 240), subdir="demo_frames_video_a")
    paths_b = create_constant_frames(n=n, size=(320, 240), subdir="demo_frames_video_b")
