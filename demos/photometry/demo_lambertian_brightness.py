...
* demo:     `python demo_lambertian_brightness.py`
            ...
            `ssapy_toolkit.plots.figsave` into demo_gallery/figures/.
...
def _demo_figures():
    ...
    fig.tight_layout()
    figsave(fig, "demo_gallery/figures/demo_phase_curve_benchmark.jpg")
    plt.close(fig)
    ...
    ax.grid(alpha=0.3)
    fig.tight_layout()
    figsave(fig, "demo_gallery/figures/demo_fractional_flux_benchmark.jpg")
    plt.close(fig)
    ...
    fig.tight_layout()
    figsave(fig, "demo_gallery/figures/demo_airmass_and_bands.jpg")
    plt.close(fig)

    print("Saved via figsave: demo_gallery/figures/demo_phase_curve_benchmark.jpg")
    print("Saved via figsave: demo_gallery/figures/demo_fractional_flux_benchmark.jpg")
    print("Saved via figsave: demo_gallery/figures/demo_airmass_and_bands.jpg")
