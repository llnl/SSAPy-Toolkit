...
orbit_plot(r=[r, r3], t=[t, t3], save_path=figpath("tests/demo_orbit_plot_two_different_length_orbits"))
orbit_plot(r=[r, r3], t=[t, t3], save_path=figpath("tests/demo_orbit_plot_two_different_length_orbits_itrf"), frame='itrf')
cislunar_plot(r=[r, r3], t=[t, t3], save_path=figpath("tests/demo_cislunar_plot_two_different_length_orbits"))
globe_plot(r=[r, r3], t=[t, t3], save_path=figpath("tests/demo_globe_two_different_length_orbits"), scale=5, c='black')
